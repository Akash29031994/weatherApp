...
export class WeatherMapComponent implements OnInit {
  ...
  constructor(private _weatherSerive: WeatherService) { }

  ngOnInit() {
    if (this._weatherSerive.getMapDetails()) {
      this.lat = parseFloat('' + this._weatherSerive.getMapDetails().lat);
      this.lng = parseFloat('' + this._weatherSerive.getMapDetails().lon);
    }
  }
  // tslint:disable
  title = 'Weather Map';
